...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/24 17:33:07 by abalhamm          #+#    #+#             */
/*   Updated: 2024/02/24 18:04:34 by abalhamm         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Span::addMoreNum(int size)
{
	...
	{
		this->_vector.insert(this->_vector.begin(), rand() % 300);
	}
...
int	Span::longestSpan()
{
	...
	if (this->_vector.size() < 1)
		throw Span::EmptyContainer();
	std::sort(this->_vector.begin(), this->_vector.end());
	longSpan = this->_vector[this->_vector.size() - 1] - this->_vector[0];
	return(longSpan);
}
